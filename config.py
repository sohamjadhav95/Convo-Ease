...
_API_KEY = (
    ...
    or TESTING_NVIDIA_API_KEY.strip()
    or ""
)
_API_BASE_URL = (
    os.getenv("NVIDIA_API_URL")
    or os.getenv("NVIDIA_NIM_API_URL")
    or os.getenv("CONVOEASE_API_URL")
...
IMAGE_MODEL_CONFIG = {
    ...
    "api_key": _API_KEY,
    "base_url": _API_BASE_URL,
    "api_model_id": os.getenv("CONVOEASE_IMAGE_MODEL_ID", "meta/llama-3.2-90b-vision-instruct"),
...
AUDIO_MODEL_CONFIG = {
    # Audio moderation now runs through local Whisper for reliability on CPU/GPU.
    "backend": "local",
    "api_key": _API_KEY,
    "base_url": _API_BASE_URL,
    ...
    "api_summary_model_id": os.getenv("CONVOEASE_AUDIO_SUMMARY_MODEL_ID", "openai/gpt-oss-120b"),
}
